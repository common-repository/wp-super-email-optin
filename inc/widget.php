...
function wp_super_optin_widget_init() {
	...
	function wp_super_optin_widget($args) {
		...
		$options = get_option('wp_super_optin_widget');
	...
	function wp_super_optin_widget_control() {
		...
		$newoptions = get_option('wp_super_optin_widget');
		...
		if ( $options != $newoptions ) {
			...
			update_option('wp_super_optin_widget', $options);
...
?>
	...
	wp_register_sidebar_widget('wpemailcapture','WP Super Optin', 'wp_super_optin_widget');



	// This registers the (optional!) widget control form.

	wp_register_widget_control('wpemailcapture','WP Super Optin', 'wp_super_optin_widget_control');
...
add_action('plugins_loaded', 'wp_super_optin_widget_init');
