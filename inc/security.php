...
function superoptin_wp_email_injection_chars($s) {
...
function wp_super_optin_bsafe($input) {
...
function superoptin_wp_email_stripslashes($s) {
...
function superoptin_wp_email_injection_test($str) { 
